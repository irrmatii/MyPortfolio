        ...
        <div id="About" className="w-full flex justify-end relative about-section">
            <div className=" w-full md:w-[72%] flex flex-col items-center bg-[#111] rounded-bl-2xl">
                <div className="w-full h-screen flex flex-col items-center relative">
                    <div className="relative inline-block pt-[5%] md:pt-[4%] lg:pt-[2%] md:pl-[15%] lg:pl-[20%]">
                    ...
                    <div className="w-[60%] h-full flex flex-col items-center justify-around gap-3 text-center text-3xl pl-5 pr-5 z-20">
                        ...
                        <div className='w-full h-auto flex justify-center gap-3'>
                            <a href="#Contact" className='w-[8%] h-auto'>
                                <svg className="w-full h-full fill-[#ffffff] hover:fill-[#afd9f5] hover:scale-110 transition-all duration-400" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                     viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://github.com/irrmatii" target="_blank" className="w-[8%]">
                                <svg className="w-full h-auto fill-[#ffffff] hover:fill-[#afd9f5] hover:scale-110 transition-all duration-400" xmlns="http://www.w3.org/2000/svg" width="30"
                                     height="30"
                                     viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://www.linkedin.com/in/irma-ti%C5%A1kut%C4%97-come-in/" target="_blank" className="w-[8%]">
                                <svg className="w-full h-auto fill-[#ffffff] hover:fill-[#afd9f5] hover:scale-110 transition-all duration-400" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                     viewBox="0 0 24 24">
                                    <path
