            ...
            <div className="w-full h-full mr-[10%] ml-[10%]">
                <div className="w-full h-full flex flex-col">
                    <div className="w-full flex justify-center pb-30 pt-10 relative">
                        <h1 className="text-8xl text-[#aaa3c0] text-shadow font-(family-name:--font-primary)">Skills</h1>
                        <h1 className="text-5xl font-bold text-shadow-white tracking-widest absolute bottom-28 z-40 font-(family-name:--font-secondary)">Skills</h1>
                    </div>

                    <div className="w-full h-full flex flex-wrap items-center justify-center gap-8 pb-30">

                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center group">
                            <div className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#8c733e] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">HTML
                                </div>
                                <svg
                                    className="w-[80%] h-auto text-shadow group-hover:scale-110  transition-transform duration-300 drop-shadow-lg"
                                    aria-hidden="true"
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center group">
                            <div className="flex w-full flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#2f4a5e] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">CSS
                                </div>
                                <svg
                                    className="w-[80%] h-auto text-shadow group-hover:scale-110 transition-transform duration-300"
                                    aria-hidden="true"
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center group">
                            <div
                                ...
                                <div
                                    className="text-[#8a4f56] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">JavaScript
                                </div>
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#3a6541] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">TypeScript
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 24 24">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className=" text-[#9c8141] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">React
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 25 25">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#668f94] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Vite
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 25 25">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#725bb0] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Tailwind
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 24 24">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#4b5f41] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Bootstrap
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 26 26">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                ...
                                <div
                                    className=" font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Node.Js
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 27 27">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#622735] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Mongo
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 24 24">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#9f4b10] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Git
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 0 24 24">
                        ...
                        <div className="relative w-[8%] group flex flex-col gap-2 items-center justify-center">
                            <div
                                className="flex flex-col gap-2 items-center justify-center animate-[flying_4s_linear_infinite]">
                                <div
                                    className="text-[#5e075e] font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity">Sockets.io
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-[80%] h-auto text-shadow group-hover:scale-105 transition-transform duration-300"
                                     viewBox="0 -2 37 37">
