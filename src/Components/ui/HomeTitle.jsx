    ...
    return (
        <div className="absolute w-full top-[5%] md:top-[4%] lg:top-[2%] flex flex-col md:flex-row items-center md:items-end gap-2 w-full z-20">
            <div className="flex justify-center md:justify-end items-center w-1/2 ">
                ...
                <div className="h-full flex flex-col justify-end items-center pb-[4%]">
                    <div className="flex leading-none">
                        <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) word-am">a</h1>
                        <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) word-am">m</h1>
                    </div>
                    <div className="flex leading-none">
                        <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) name">r</h1>
                        <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) name">m</h1>
                        <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) name">a</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="w-1/2 h-full leading-none flex items-end justify-center md:justify-start md:pb-[5.2%] gap-2">
                <div>
                    <h1 className="text-[clamp(60px,calc(10vw+1rem),300px)] font-(family-name:--font-fourth) text-white opacity-90">Tiskute</h1>
                </div>
                <div
